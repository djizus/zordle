...
# WARNING: VITE_PUBLIC_BURNER_PRIVATE_KEY is the deployer key. For a v1
# public demo this is intentional — every player shares one Sepolia
# account that signs guesses on their behalf. Do not put real value
# at this address.
VITE_PUBLIC_NODE_URL=$RPC_URL
VITE_PUBLIC_BURNER_ADDRESS=$DEPLOYER_ADDRESS
VITE_PUBLIC_BURNER_PRIVATE_KEY=$DEPLOYER_PRIVATE_KEY
